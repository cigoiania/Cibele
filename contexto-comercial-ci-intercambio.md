...
**Modelo F — Liberação com porta aberta (lead frio / "não é o momento")**
...
um lead que esfriou após o atendimento. Ver **Modelo F** (Seção 7).
...
- [ ] Validar com o Marcelo a redação do **Modelo F** (liberação com porta
  aberta / lead frio).
...
- **2026-07-23** — Caso real (lead **Camila**): cotação presencial de **curso de
  ...
  **não insistir** — liberar com porta aberta, com empatia, e passar a iniciativa
  ...
  pronto). Criados o **Modelo F** (Seção 7) e a subseção de **objeção de momento**
  (Seção 8); stub do produto **italiano/Itália** (Seção 2) e pendências abertas.
  Redação do Modelo F a validar com o Marcelo.
